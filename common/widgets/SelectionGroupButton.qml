...
GroupButton {
    ...
    leftRadius: (toggled || leftmost) ? (height / 2) : 10
    rightRadius: (toggled || rightmost) ? (height / 2) : 10
    colBackground: Appearance.colors.darkSecondary
    colBackgroundHover: Appearance.colors.secondary
    colBackgroundActive: Appearance.colors.main
        ...
        Loader {
            ...
            sourceComponent: Item {
                ...
                MaterialSymbol {
                    ...
                    iconSize: 20
                    color: root.toggled ? Appearance.colors.main : Appearance.colors.secondary
                }
            }
        }
