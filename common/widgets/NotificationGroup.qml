...
MouseArea { // Notification group area
    ...
    Rectangle { // Background of the notification
        ...
        topLeftRadius: popup ? 0 : Appearance.configs.windowRadius
        topRightRadius: popup ? 0 : Appearance.configs.windowRadius
        bottomRightRadius: popup ? 0 : Appearance.configs.windowRadius
            ...
            ColumnLayout { // Content
                ...
                Item { // App name (or summary when there's only 1 notif) and time
                    ...
                    NotificationGroupExpandButton {
                        ...
                        // StyledToolTip {
                        //     content: "Tip: right-clicking a group\nalso expands it"
                        // }
                    }
                }
