            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        color: copyMouse.containsMouse ? Appearance.colors.darkSecondary : Qt.lighter(Appearance.colors.moduleBackground, 1.1)
                        Behavior on color {
                    ...
                    Rectangle {
                        ...
                        color: closeMouse.containsMouse ? Appearance.colors.darkSecondary : Qt.lighter(Appearance.colors.moduleBackground, 1.1)
                        Behavior on color {
                            ColorAnimation { duration: 150 }
                        }
