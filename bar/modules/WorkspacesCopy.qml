            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Text {
                        ...
                        text: Icons.dot
                        color: wsItem.isHovered ? DefaultStyle.colors.extraBrightGrey
                            : wsItem.isActive  ? DefaultStyle.colors.activeWorkspaceBorder
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            delegate: IconImage {
                                width: 16; height: 16
                                source: root.appIcons[wsItem.apps[index]] || root.defaultIconsPath + missingIconImage
                        ...
                        Text {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            color: DefaultStyle.colors.extraBrightGrey
                            font.pixelSize: 8
